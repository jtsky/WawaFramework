 ...
 * 作    者：jint（金台）
 * 版    本：1.0
 * 创建日期：2018/6/14-14:51
 * 描    述：集成Fragmentation的Fragment
 * 修订历史：
 * ================================================
 */
public abstract class BaseFragmentationFragment<Model extends ViewModel, V extends DuibaMvpView, P extends DuibaMvpPresenter<Model, V>> extends BaseFragment<Model, V, P> implements ISupportFragment {
