 ...
 * 描    述：集成Fragmentation的Activity
 * 修订历史：
 * ================================================
 */
public abstract class BaseFragmentationActivity<Model extends ViewModel, V extends DuibaMvpView, P extends DuibaMvpPresenter<Model, V>> extends BaseActivity<Model, V, P> implements ISupportActivity {
